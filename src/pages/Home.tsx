...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>Portfolio — Développeur Web & Mobile</title>
        <meta
          name="description"
          content="Développeur web et mobile freelance..."
        />
        <meta
          property="og:title"
          content="Portfolio — Développeur Web & Mobile"
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-[1.2fr_1fr] gap-12 items-center">
            <div>
              ...
              <p className="mt-8 text-lg text-muted-foreground max-w-xl leading-relaxed">
                Développeur web et mobile. Je transforme des idées ambitieuses
                en interfaces fluides, performantes et soignées — du premier
                wireframe au déploiement.
              </p>
        ...
        <section
          id="about"
          className="py-24 px-6 border-t max-h-170 border-border"
          style={{ backgroundImage: "var(--gradient-hero)" }}
        >
          <div className="max-w-6xl mx-auto">
            {/* <div className="text-center"> */}
            <p className="text-sm text-center text-primary mb-8 uppercase tracking-widest">
              À propos
            </p>
            ...
            <div className="grid md:grid-cols-2 items-center ">
              ...
              >
                <img
                  ...
                  height="290px"
                  width="230px"
                  className="border text-center rounded-[50%] border-primary animate-pulse"
                />
              </motion.div>
              <motion.div
                variants={aboutText}
              ...
              >
                <span className="text-xl md:text-3xl font-bold tracking-tight pb-4 text-white">
                  Salut 👋
                </span>
                <p className="text-lg sm:pt-0 pt-10 md:pb-0 pb-8 text-muted-foreground leading-relaxed">
                  <span className="text-white font-semibold text-lg">
                    Je me nomme Theodore Lima{" "}
                    <span className="text-primary">alias Li't Dev</span>.
                  </span>{" "}
                  <br />
                  Je suis un développeur passionné par les beaux produits qui
                  fonctionnent. Depuis 2 ans, j'accompagne startups et
                  entreprises dans la création d'expériences digitales, du
                  concept jusqu'au déploiement. <br /> Mon obsession :
                  l'attention au détail, la performance et le soin apporté à
                  chaque interaction avec un esprit créatif.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-24 px-6 border-t border-border">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={s.title}
                className="p-8 rounded-2xl bg-card border border-border transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/10 "
              >
